...
const about_me = [
  <p>I'm a Data Scientist based in Waterloo, Canada. Currently I am working at <a className="highlight" href="https://wish.com" target="_blank" rel="noopener noreferrer">Wish</a> as a Data Scientist on the Consumer Data Team. Over last summer I worked at <a className="highlight" href="https://wish.com" target="_blank" rel="noopener noreferrer">Wish</a> as a Software Developer on the Product Payments Team. In my free time, I help run a design agency <a className="highlight" href="https://thesage.co" target="_blank" rel="noopener noreferrer">Sage Co</a> to help develop websites and brand identities for small businesses.</p>,
