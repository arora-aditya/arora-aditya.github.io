...
export default function Home() {
  ...
  const formattedLastRead = lastRead && <span>currently reading <FancyLink href={`https://www.goodreads.com/search?q=${lastRead[1].title} by ${lastRead[1].author}`} className="highlight" target="_blank">{lastRead[1].title}</FancyLink> by {lastRead[1].author}</span>

  const about_me = [
    <p>I'm a Software Engineer and Data Scientist based in Canada. I'm currently working at <FancyLink className="highlight" href="https://google.ca" target="_blank" rel="noopener noreferrer">Google</FancyLink> as AI Uber Tech Lead, leading internal and external AI engineering efforts within Google Cloud FinOps. My past experience has been a mix of full-stack and data science.</p>,
