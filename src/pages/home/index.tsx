...
const about_me = [
  <p>I'm a Software Engineer and Data Scientist based in Waterloo, Canada. Over the winter, I worked at <a className="highlight" href="https://wish.com" target="_blank" rel="noopener noreferrer">Wish</a> as a Data Scientist on the Consumer Data Team. In the Summmer of 2020, I worked at <a className="highlight" href="https://wish.com" target="_blank" rel="noopener noreferrer">Wish</a> as a Software Developer on the Product Payments Team. In my free time, I've helped start a design agency <a className="highlight" href="https://thesage.co" target="_blank" rel="noopener noreferrer">Sage Co</a> to help develop websites and brand identities for small businesses.</p>,
