...
export default function Home() {
  ...
  const about_me = [
    <p>I'm a Software Engineer and Data Scientist based in Canada. Starting in August, I'll be working at <FancyLink className="highlight" href="https://google.ca" target="_blank" rel="noopener noreferrer">Google</FancyLink> as Software Engineer on the GCloud - Cost Optimization team. My past experience has been a mix of full-stack and data science.</p>,
    <p>My last 3 internships have been at <FancyLink className="highlight" href="https://wish.com" target="_blank" rel="noopener noreferrer">Wish</FancyLink> first as a Software Engineer on the Payments team, and then as a Data Scientist / ML Engineer on the Consumer Data team. Before that I have worked for startups in the Food-tech and Ads space.</p>,
